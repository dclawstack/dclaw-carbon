...
**DClaw Carbon** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8035` (FastAPI)
- **Frontend Port:** `3035` (Next.js)
- **Database:** `dclaw_carbon` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3035`
